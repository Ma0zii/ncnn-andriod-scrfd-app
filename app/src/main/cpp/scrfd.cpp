...
static ncnn::Mat generate_anchors(int base_size, const ncnn::Mat& ratios, const ncnn::Mat& scales)
{
    ...
    // 第一个参数是整数 4，表示创建的矩阵或张量的维度；
    // 第二个参数是 num_ratio * num_scalr，表示矩阵或张量的元素数量。
...
std::vector<FaceObject> detect_scrfd(const ncnn::Net &scrfd, ncnn::Mat in1){

    cv::Mat a(in1.h, in1.w, CV_8UC3);
    in1.to_pixels(a.data, ncnn::Mat::PIXEL_RGB);
    ...
    ncnn::Mat in = ncnn::Mat::from_pixels_resize(a.data, ncnn::Mat::PIXEL_RGB, width, height, w, h);
